...
#define I_BERRY_PRICE                   GEN_7       // Since BT    erries have become unplantable (Gen8+), their price has gone up.
...
#define I_EXP_SHARE_FLAG        FLAG_HAS_XP_SHARE // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
