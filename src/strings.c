...
const u8 gText_DexNatTitle[] = _("National Deck");
...
const u8 gText_DexHoennDescription[] = _("Hoenn regional Pokédex");
...
const u8 gText_NoPokemon[] = _("You don't have\nany Pokémon?");
...
{
    [POCKET_ITEMS] =        COMPOUND_STRING("Misc. Items"),
...
const u8 gText_ThrowInPremierBall[] = _("Here. Have a Premier Ball, too.{PAUSE_UNTIL_PRESS}");
